...
&ensp;&ensp;<a href='#3.2'>3.2、@RestController</a>
&ensp;&ensp;<a href='#3.3'>3.3、@Valid</a>
&ensp;&ensp;<a href='#3.4'>3.4、@ExceptionHandler</a>
<a href='#4'>4、在service中添加参数验收</a>
&ensp;&ensp;<a href='#4.1'>4.1、实现方法 </a>
&ensp;&ensp;<a href='#4.2'>4.2、注意事项</a>
<a href='#5'>5、分组验收</a>
&ensp;&ensp;<a href='#5.1'>5.1、使用场景 </a>
&ensp;&ensp;<a href='#5.2'>5.2、实现</a>
<a href='#6'>6、自定义注解</a>
&ensp;&ensp;<a href='#6.1'>6.1、实现 </a>
<a href='#7'>7、校验List中的参数</a>
&ensp;&ensp;<a href='#7.1'>7.1、获取validtor</a>
&ensp;&ensp;<a href='#7.2'>7.2、创建自定义注解</a>
&ensp;&ensp;<a href='#7.3'>7.3、创建注解处理类</a>	
